...
my $rmu = {
	...
	sun => (2.9591220836841438269e-04) * 133407.5625,
	mer => (2.9591220836841438269e-04 + 4.9125474514508118699e-11) * 133407.5625,
	ven => (2.9591220836841438269e-04 + 7.2434524861627027000e-10) * 133407.5625,
	emb => (2.9591220836841438269e-04 + 8.9970116036316091182e-10) * 133407.5625,
	ear => (2.9591220836841438269e-04 + 8.9970116036316091182e-10) * 133407.5625,
	mar => (2.9591220836841438269e-04 + 9.5495351057792580598e-11) * 133407.5625,
	jup => (2.9591220836841438269e-04 + 2.8253458420837780000e-07) * 133407.5625,
	sat => (2.9591220836841438269e-04 + 8.4597151856806587398e-08) * 133407.5625,
	nep => (2.9591220836841438269e-04 + 1.2920249167819693900e-08) * 133407.5625,
	ura => (2.9591220836841438269e-04 + 1.5243589007842762800e-08) * 133407.5625,
	plu => (2.9591220836841438269e-04 + 2.1886997654259696800e-12) * 133407.5625,
};
...
sub gen_vsop87
{
	...
	my $code = "// generated by vsop87.pl\n";
	...
	$code .= "${theory}.${body}" # vsop87[" . ($part - 1) ."] = 
		. " = VSOP87('${body}', $rmu->{${body}}, ${coeffs});\n";

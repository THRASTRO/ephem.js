...
function vsop87a_mer(jy) { return vsop87(vsop87a_mer.coeffs, jy); }
vsop87a_mer.coeffs = {
...
vsop87a.mer = vsop87a_mer; // export function
;

function vsop87a_ven(jy) { return vsop87(vsop87a_ven.coeffs, jy); }
vsop87a_ven.coeffs = {
...
vsop87a.ven = vsop87a_ven; // export function
;

function vsop87a_ear(jy) { return vsop87(vsop87a_ear.coeffs, jy); }
vsop87a_ear.coeffs = {
...
vsop87a.ear = vsop87a_ear; // export function
;

function vsop87a_emb(jy) { return vsop87(vsop87a_emb.coeffs, jy); }
vsop87a_emb.coeffs = {
...
vsop87a.emb = vsop87a_emb; // export function
;

function vsop87a_mar(jy) { return vsop87(vsop87a_mar.coeffs, jy); }
vsop87a_mar.coeffs = {
...
vsop87a.mar = vsop87a_mar; // export function
;

function vsop87a_jup(jy) { return vsop87(vsop87a_jup.coeffs, jy); }
vsop87a_jup.coeffs = {
...
vsop87a.jup = vsop87a_jup; // export function
;

function vsop87a_sat(jy) { return vsop87(vsop87a_sat.coeffs, jy); }
vsop87a_sat.coeffs = {
...
vsop87a.sat = vsop87a_sat; // export function
;

function vsop87a_ura(jy) { return vsop87(vsop87a_ura.coeffs, jy); }
vsop87a_ura.coeffs = {
...
vsop87a.ura = vsop87a_ura; // export function
;

function vsop87a_nep(jy) { return vsop87(vsop87a_nep.coeffs, jy); }
vsop87a_nep.coeffs = {
...
vsop87a.nep = vsop87a_nep; // export function
;
})(vsop87a)
/* crc: 29696C17255F8450239102ABC7EEC680 */

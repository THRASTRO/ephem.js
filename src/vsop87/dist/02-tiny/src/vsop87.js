...
function vsop87_mer(tj) { return vsop87(vsop87_mer.coeffs, tj); }
function vsop87_mer_xyz(tj) { return vsop87.xyz(vsop87_mer.coeffs, tj); }
vsop87_mer.xyz = vsop87_mer_xyz; // assign
vsop87.mer = vsop87_mer; // export
vsop87_mer.coeffs = {
	a: [[0.38709830982,0,0]],
...
;
// generated by vsop87.pl
function vsop87_ven(tj) { return vsop87(vsop87_ven.coeffs, tj); }
function vsop87_ven_xyz(tj) { return vsop87.xyz(vsop87_ven.coeffs, tj); }
vsop87_ven.xyz = vsop87_ven_xyz; // assign
vsop87.ven = vsop87_ven; // export
vsop87_ven.coeffs = {
	a: [[0.72332981996,0,0]],
...
;
// generated by vsop87.pl
function vsop87_emb(tj) { return vsop87(vsop87_emb.coeffs, tj); }
function vsop87_emb_xyz(tj) { return vsop87.xyz(vsop87_emb.coeffs, tj); }
vsop87_emb.xyz = vsop87_emb_xyz; // assign
vsop87.emb = vsop87_emb; // export
vsop87_emb.coeffs = {
	a: [[1.00000101778,0,0]],
...
;
// generated by vsop87.pl
function vsop87_mar(tj) { return vsop87(vsop87_mar.coeffs, tj); }
function vsop87_mar_xyz(tj) { return vsop87.xyz(vsop87_mar.coeffs, tj); }
vsop87_mar.xyz = vsop87_mar_xyz; // assign
vsop87.mar = vsop87_mar; // export
vsop87_mar.coeffs = {
	a: [[1.52367934191,0,0]],
...
;
// generated by vsop87.pl
function vsop87_jup(tj) { return vsop87(vsop87_jup.coeffs, tj); }
function vsop87_jup_xyz(tj) { return vsop87.xyz(vsop87_jup.coeffs, tj); }
vsop87_jup.xyz = vsop87_jup_xyz; // assign
vsop87.jup = vsop87_jup; // export
vsop87_jup.coeffs = {
	a: [[5.20260319132,0,0]],
...
;
// generated by vsop87.pl
function vsop87_sat(tj) { return vsop87(vsop87_sat.coeffs, tj); }
function vsop87_sat_xyz(tj) { return vsop87.xyz(vsop87_sat.coeffs, tj); }
vsop87_sat.xyz = vsop87_sat_xyz; // assign
vsop87.sat = vsop87_sat; // export
vsop87_sat.coeffs = {
...
;
// generated by vsop87.pl
function vsop87_ura(tj) { return vsop87(vsop87_ura.coeffs, tj); }
function vsop87_ura_xyz(tj) { return vsop87.xyz(vsop87_ura.coeffs, tj); }
vsop87_ura.xyz = vsop87_ura_xyz; // assign
vsop87.ura = vsop87_ura; // export
vsop87_ura.coeffs = {
...
;
// generated by vsop87.pl
function vsop87_nep(tj) { return vsop87(vsop87_nep.coeffs, tj); }
function vsop87_nep_xyz(tj) { return vsop87.xyz(vsop87_nep.coeffs, tj); }
vsop87_nep.xyz = vsop87_nep_xyz; // assign
vsop87.nep = vsop87_nep; // export
vsop87_nep.coeffs = {
...
/* crc: 3265512D6F68D8C30CCE6AA6CA982145 */

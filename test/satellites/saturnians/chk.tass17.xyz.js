(function (tests, QUnit)
{
		...
		QUnit.module("Satellite " + body, function ()
		{
			...
			QUnit.test("Coordinatess", function (assert)
			{
				...
				for (var i = 0; i < tests[body].length; i += 1) {
					...
					saturnian[name].state(jy2k, elem = []);
					...
					var orb = saturnian[name].orbit(jy2k, elem = {});
					...
					assert.equal(orb._GM, saturnian[name].GM, "Orbit has GM");
	...
	QUnit.module("Saturnian TASS17", function ()
	{
...
})(saturian_tass17_results_xyz, QUnit);
